...
def _zero_counts(total: int = 0) -> RegionCounts:
    return RegionCounts(
        ...
        rebuild_app_received_parcels=0,
        rebuild_zoning_cleared_parcels=0,
        rebuild_plans_received_parcels=0,
        rebuild_plans_approved_parcels=0,
        rebuild_permit_issued_parcels=0,
        rebuild_in_construction_parcels=0,
        rebuild_construction_completed_parcels=0,
        rebuild_new_plans_received_parcels=0,
        rebuild_new_plans_approved_parcels=0,
        rebuild_new_permit_issued_parcels=0,
        rebuild_new_in_construction_parcels=0,
        rebuild_new_construction_completed_parcels=0,
        lfl_count=0,
        nlfl_count=0,
        lfl_unknown_count=0,
